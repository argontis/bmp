...
<head>
    ...
    <title>Kontak - Bakti Merah Putih</title>
                ...
                <header class="fixed top-0 inset-x-0 z-50 transition-all duration-300 bg-transparent" style="height: 88px;">
                    ...
                    <div class="max-w-[1280px] mx-auto px-6 h-full flex items-center justify-between gap-6">
                        ...
                        <nav class="hidden xl:flex items-center gap-0.5">
                            ...
                            <button onclick="window.location.href='/relawan'" class="relative px-3 py-2 text-[13px] font-semibold transition-colors duration-150 text-[#5B5B5B] hover:text-[#12355B] text-white/80 hover:text-white">
                                Relawan
                            </button>
                ...
                <main class="min-h-screen bg-[#FBFAF7]">
                    ...
                    <div class="bg-[#12355B] text-white pt-[140px] pb-32 relative overflow-hidden">
                        ...
                        <div class="max-w-[1280px] mx-auto px-6 relative z-10 text-center">
                            <h1 class="text-4xl md:text-5xl font-extrabold mb-6" style="font-family: 'Plus Jakarta Sans', sans-serif;">Hubungi Kami</h1>
                            <p class="text-white/80 max-w-2xl mx-auto text-lg leading-relaxed">Kami selalu terbuka untuk pertanyaan, saran, maupun inisiatif kolaborasi. Jangan ragu untuk meninggalkan pesan.</p>
                        </div>
                    </div>
                    ...
                    <div class="max-w-[1280px] mx-auto px-6 -mt-20 relative z-20 pb-24">
                        <div class="grid lg:grid-cols-5 gap-8">
                            ...
                            <div class="lg:col-span-2 flex flex-col gap-6">
                                <!-- Address Card -->
                                <div class="bg-white p-8 rounded-3xl shadow-lg shadow-black/5 border border-gray-100 flex items-start gap-6 hover:-translate-y-1 transition-transform">
                                    <div class="w-14 h-14 shrink-0 rounded-full bg-red-50 flex items-center justify-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin w-6 h-6 text-[#D62828]"><path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0"></path><circle cx="12" cy="10" r="3"></circle></svg>
                                    </div>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#1B1B1B] mb-2" style="font-family: 'Plus Jakarta Sans', sans-serif;">Kantor Pusat</h3>
                                        <p class="text-gray-500 leading-relaxed text-sm"><a href="https://maps.app.goo.gl/UVL5JZcLoiSfMHMb6" target="_blank" class="hover:text-[#D62828] transition-colors">Gedung Bakti Merah Putih, Jl. Sudirman No. 45, Kel. Karet Semanggi, Kec. Setiabudi, Jakarta Pusat 10220</a></p>
                                    </div>
                                </div>
                                
                                <!-- Phone Card -->
                                <div class="bg-white p-8 rounded-3xl shadow-lg shadow-black/5 border border-gray-100 flex items-start gap-6 hover:-translate-y-1 transition-transform">
                                    <div class="w-14 h-14 shrink-0 rounded-full bg-blue-50 flex items-center justify-center">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-bold text-[#1B1B1B] mb-2" style="font-family: 'Plus Jakarta Sans', sans-serif;">Nomor Telepon</h3>
                                        <div class="space-y-1">
                                            <p class="text-gray-500 font-medium">0856-104-2026 (WhatsApp/Telepon)</p>
                                            <p class="text-gray-500 font-medium">+62 811 1234 5678 (WhatsApp)</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- Email Card -->
                                <div class="bg-white p-8 rounded-3xl shadow-lg shadow-black/5 border border-gray-100 flex items-start gap-6 hover:-translate-y-1 transition-transform">
                                    <div class="w-14 h-14 shrink-0 rounded-full bg-teal-50 flex items-center justify-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail w-6 h-6 text-teal-600"><rect width="20" height="16" x="2" y="4" rx="2"></rect><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path></svg>
                                    </div>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#1B1B1B] mb-2" style="font-family: 'Plus Jakarta Sans', sans-serif;">Alamat Email</h3>
                                        <div class="space-y-1">
                                            <p class="text-gray-500 font-medium">info@baktimerahputih.org</p>
                                            <p class="text-gray-500 font-medium">partnership@baktimerahputih.org</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="lg:col-span-3">
                                <div class="bg-white p-8 md:p-10 rounded-3xl shadow-xl shadow-black/5 border border-gray-100">
                                    ...
                                    <form action="{{ route('kontak.send') }}" method="POST" class="space-y-6">
                                        ...
                                        <!-- Subject -->
                                        <div>
                                            <label for="subject" class="block text-sm font-bold text-gray-700 mb-2">Subjek Pesan <span class="text-[#D62828]">*</span></label>
                                            <select id="subject" name="subject" class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#D62828]/20 focus:border-[#D62828] transition-colors text-sm font-medium appearance-none" required>
                                                <option value="" disabled selected>Pilih Tujuan Pesan</option>
                                                <option value="pertanyaan">Pertanyaan Umum</option>
                                                <option value="kolaborasi">Kolaborasi & Kemitraan (CSR)</option>
                                        ...
                                        <!-- Message -->
                                        <div>
                                            <label for="message" class="block text-sm font-bold text-gray-700 mb-2">Isi Pesan <span class="text-[#D62828]">*</span></label>
                                            <textarea id="message" name="message" rows="5" placeholder="Tuliskan pesan, pertanyaan, atau penawaran Anda di sini..." class="w-full px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#D62828]/20 focus:border-[#D62828] transition-colors text-sm font-medium resize-none" required></textarea>
                                        </div>
                                        
                                        <!-- Submit Button -->
                                        <button type="submit" class="w-full px-8 py-4 rounded-xl bg-[#D62828] hover:bg-[#B91C1C] text-white font-bold transition-all shadow-[0_8px_25px_-8px_rgba(214,40,40,0.6)] hover:-translate-y-0.5 flex items-center justify-center gap-2">
                                            Kirim Pesan <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-send w-4 h-4"><path d="m22 2-7 20-4-9-9-4Z"></path><path d="M22 2 11 13"></path></svg>
                                        </button>
                                    </form>
                                </div>
                            </div>
