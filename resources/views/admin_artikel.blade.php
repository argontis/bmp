...
<body class="bg-gray-50 text-gray-800 font-sans antialiased selection:bg-primary selection:text-white flex h-screen overflow-hidden">
    ...
    <aside class="w-[280px] bg-secondary flex flex-col h-screen shrink-0 relative overflow-hidden hidden md:flex">
        ...
        <nav class="flex-1 py-8 px-4 overflow-y-auto relative z-10 space-y-2">
            ...
            <a href="{{ route('admin.artikel') }}" class="flex items-center gap-4 px-4 py-3.5 rounded-xl bg-primary text-white font-bold shadow-lg shadow-red-500/20 transition-all font-medium">
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td class="py-5 px-8">
                                    @if($article->image)
                                        <img src="{{ asset($article->image) }}" alt="Thumbnail" class="w-20 h-16 object-cover rounded-lg border border-gray-200 shadow-sm">
                                    @else
