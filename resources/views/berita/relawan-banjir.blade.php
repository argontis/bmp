                ...
                <header class="fixed top-0 inset-x-0 z-50 transition-all duration-300 bg-white shadow-sm" style="height: 88px;">
                    ...
                    <div class="max-w-[1280px] mx-auto px-6 h-full flex items-center justify-between gap-6">
                        ...
                        <nav class="hidden xl:flex items-center gap-0.5">
                            ...
                            <button onclick="window.location.href='/login'" class="relative px-3 py-2 text-[13px] font-semibold transition-colors duration-150 text-[#5B5B5B] hover:text-[#12355B] ">
                                Donasi
                            </button>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button onclick="window.location.href='/login'" class="xl:hidden p-2.5 rounded-xl hover:bg-black/5 transition-colors" style="color: #1B1B1B;">
        ...
        <div class="max-w-[800px] mx-auto px-6 py-12 md:py-16">
            <div class="mb-8">
                <div class="flex items-center gap-3 mb-6">
                    <span class="px-4 py-1.5 rounded-full text-xs font-bold text-white" style="background: rgb(29, 78, 216);">Kebencanaan</span>
                    <span class="text-sm font-semibold text-gray-500">8 Juli 2026</span>
                    <span class="text-gray-300">•</span>
                    <span class="text-sm font-semibold text-gray-500">6 menit baca</span>
                </div>
                <h1 class="text-4xl md:text-[42px] font-extrabold text-[#12355B] leading-[1.2] mb-6" style="font-family: 'Plus Jakarta Sans', sans-serif;">Sigap di Lapangan: Tim Relawan Bakti Pulihkan 3 Desa Pasca Banjir</h1>
            </div>
            
            <div class="w-full h-[400px] md:h-[500px] rounded-[24px] overflow-hidden mb-12 shadow-lg">
                <img src="https://images.unsplash.com/photo-1617494532674-67d22df2addb?w=1200&h=600&fit=crop&auto=format" alt="Sigap di Lapangan: Tim Relawan Bakti Pulihkan 3 Desa Pasca Banjir" class="w-full h-full object-cover">
            </div>
