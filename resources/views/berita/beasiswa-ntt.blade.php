        ...
        <div class="max-w-[800px] mx-auto px-6 py-12 md:py-16">
            <div class="mb-8">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <span class="text-sm font-semibold text-gray-500">15 Juli 2026</span>
            ...
            <div class="w-full h-[400px] md:h-[500px] rounded-[24px] overflow-hidden mb-12 shadow-lg">
                <img src="https://images.unsplash.com/photo-1497486751825-1233686d5d80?w=1200&h=600&fit=crop&auto=format" alt="500 Anak NTT Terima Beasiswa Bakti Merah Putih 2026" class="w-full h-full object-cover">
            </div>
