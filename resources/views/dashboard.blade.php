                    ...
                    <section class="space-y-6">
                        <div class="space-y-6 pb-8">
                            <section class="relative overflow-hidden rounded-2xl bg-[#12355B] p-6 text-white shadow-md sm:p-8">
                                <img src="{{ asset('images/hero-bg.webp') }}" alt="Kegiatan Bakti Merah Putih" class="absolute inset-0 h-full w-full object-cover opacity-20">
                                ...
                                <div class="relative z-10 max-w-2xl">
                                    ...
                                    <div class="mt-6 flex flex-wrap items-center justify-between gap-4 border-t border-white/20 pt-4 text-xs text-white/90">
                                        ...
                                        <button onclick="window.location.href='/sertifikat/download'" class="flex items-center gap-1 font-bold text-[#F4AAAA] hover:underline">Unduh Sertifikat Kebaikan <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-up-right"><path d="M7 7h10v10"></path><path d="M7 17 17 7"></path></svg></button>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section hx-get="/user/laporan" hx-push-url="true" hx-target="body" hx-swap="outerHTML transition:true" class="group cursor-pointer overflow-hidden rounded-2xl border border-[#12355B]/10 bg-white p-5 shadow-sm transition-all duration-300 hover:border-[#D62828]/40 hover:bg-[#FFF1F1]/30 hover:shadow-md sm:p-6">
