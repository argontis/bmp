...
<head>
    ...
    <title>Bakti Pangan & Gizi - Bakti Merah Putih</title>
                ...
                <main class="min-h-screen bg-[#FBFAF7]">
                    ...
                    <div class="bg-[#12355B] text-white pt-[140px] pb-24 relative overflow-hidden">
                        ...
                        <div class="max-w-[1280px] mx-auto px-6 relative z-10 text-center">
                            <h1 class="text-4xl md:text-5xl font-extrabold mb-6" style="font-family: 'Plus Jakarta Sans', sans-serif;">Bakti Pangan & Gizi</h1>
                            <p class="text-white/80 max-w-2xl mx-auto text-lg leading-relaxed">Meningkatkan gizi anak-anak dan keluarga prasejahtera melalui dapur umum dan bantuan pangan berkelanjutan.</p>
                        </div>
                    </div>
                    <!-- Program Details -->
