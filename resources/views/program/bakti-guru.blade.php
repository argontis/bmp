                        ...
                        <div class="bg-white rounded-[2rem] shadow-xl p-8 md:p-12 mb-12">
                            <div class="prose prose-lg max-w-none text-gray-600">
                                ...
                                <div class="bg-[#FBFAF7] rounded-2xl p-8 border border-gray-200 text-center">
                                    ...
                                    <button class="inline-flex items-center gap-2 px-8 py-4 bg-[#D62828] text-white rounded-full text-sm font-bold hover:bg-[#B91C1C] transition-all duration-200 shadow-[0_8px_20px_-8px_rgba(214,40,40,0.7)] hover:shadow-[0_10px_26px_-8px_rgba(214,40,40,0.85)] hover:-translate-y-0.5" onclick="window.location.href='/login'">
