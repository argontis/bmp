    ...
    <div class="hidden md:block">
        <main class="min-h-screen bg-[#FBFAF7] text-[#12355B] font-['Inter'] lg:grid lg:grid-cols-[1.1fr_.9fr] selection:bg-[#D62828] selection:text-white">
            <section class="relative hidden overflow-hidden lg:block bg-[#12355B]">
                <img src="{{ asset('images/hero1.webp') }}" alt="Relawan Bakti Merah Putih bersama penerima manfaat" class="absolute inset-0 h-full w-full object-cover opacity-60">
                ...
                <div>
                    ...
                    <div class="max-w-md mx-auto lg:mx-0">
                        ...
                        <div class="mt-6 text-center text-xs text-[#62758A]">
                            Belum terdaftar sebagai donatur? <a href="/register" class="font-bold text-[#D62828] hover:underline ml-1">Daftar sekarang</a>
                        </div>
                    </div>
                </div>
