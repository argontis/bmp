...
<head>
    ...
    <title>Laporan & Keuangan - Bakti Merah Putih</title>
                ...
                <main class="min-h-screen bg-[#FBFAF7]">
                    ...
                    <div class="bg-[#12355B] text-white pt-[140px] pb-32 relative overflow-hidden">
                        ...
                        <div class="max-w-[1280px] mx-auto px-6 relative z-10 text-center">
                            <h1 class="text-4xl md:text-5xl font-extrabold mb-6" style="font-family: 'Plus Jakarta Sans', sans-serif;">Transparansi Laporan & Keuangan</h1>
                            <p class="text-white/80 max-w-2xl mx-auto text-lg leading-relaxed">Komitmen kami untuk selalu menjaga amanah donatur dengan pelaporan yang transparan, akuntabel, dan tepat sasaran.</p>
                        </div>
                    </div>
                    ...
                    <div class="max-w-[1280px] mx-auto px-6 -mt-20 relative z-20 pb-24">
                        ...
                        <div class="bg-white rounded-[32px] p-8 md:p-12 shadow-xl border border-gray-100 mb-12">
                            <h2 class="text-2xl font-extrabold text-[#1B1B1B] mb-8" style="font-family: 'Plus Jakarta Sans', sans-serif;">Ringkasan Keuangan Tahun 2025</h2>
                            ...
                            <div class="grid md:grid-cols-2 gap-12">
                                ...
                                <div class="space-y-6">
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div>
                                            <p class="text-sm font-bold text-gray-500 uppercase tracking-wider mb-1">Total Dana Dihimpun</p>
                                            <p class="text-3xl font-extrabold text-[#1B1B1B]" style="font-family: 'Plus Jakarta Sans', sans-serif;">Rp 12.450.000.000</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="space-y-4 pt-4 border-t border-gray-100">
                                        <div>
                                            <div class="flex justify-between text-sm font-semibold mb-2">
                                                <span class="text-gray-600">Zakat & Sedekah</span>
                                                <span class="text-[#1B1B1B]">65%</span>
                                            </div>
                                        ...
                                        <div>
                                            <div class="flex justify-between text-sm font-semibold mb-2">
                                                <span class="text-gray-600">Donasi CSR Perusahaan</span>
                                                <span class="text-[#1B1B1B]">25%</span>
                                            </div>
                                            <div class="w-full bg-gray-100 h-2 rounded-full">
                                        ...
                                        <div>
                                            <div class="flex justify-between text-sm font-semibold mb-2">
                                                <span class="text-gray-600">Lain-lain (Sponsorship)</span>
                                                <span class="text-[#1B1B1B]">10%</span>
                                            </div>
                                            <div class="w-full bg-gray-100 h-2 rounded-full">
                                ...
                                <div class="space-y-6">
                                    <div class="flex items-start gap-4">
                                        <div class="w-12 h-12 rounded-2xl bg-blue-50 flex items-center justify-center shrink-0">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-heart w-6 h-6 text-blue-600"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"></path></svg>
                                        </div>
                                        <div>
                                            <p class="text-sm font-bold text-gray-500 uppercase tracking-wider mb-1">Total Dana Disalurkan</p>
                                            <p class="text-3xl font-extrabold text-[#1B1B1B]" style="font-family: 'Plus Jakarta Sans', sans-serif;">Rp 11.200.000.000</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="space-y-4 pt-4 border-t border-gray-100">
                                        <div>
                                            <div class="flex justify-between text-sm font-semibold mb-2">
                                                <span class="text-gray-600">Pendidikan & Kesehatan</span>
                                                <span class="text-[#1B1B1B]">40%</span>
                                            </div>
                                            <div class="w-full bg-gray-100 h-2 rounded-full">
                                                <div class="bg-indigo-500 h-full rounded-full" style="width: 40%"></div>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="flex justify-between text-sm font-semibold mb-2">
                                                <span class="text-gray-600">Tanggap Bencana</span>
                                                <span class="text-[#1B1B1B]">35%</span>
                                            </div>
                                            <div class="w-full bg-gray-100 h-2 rounded-full">
                                        ...
                                        <div>
                                            <div class="flex justify-between text-sm font-semibold mb-2">
                                                <span class="text-gray-600">Pemberdayaan Ekonomi & Sosial</span>
                                                <span class="text-[#1B1B1B]">25%</span>
                                            </div>
                                            <div class="w-full bg-gray-100 h-2 rounded-full">
                        ...
                        <h2 class="text-2xl font-extrabold text-[#1B1B1B] mb-8" style="font-family: 'Plus Jakarta Sans', sans-serif;">Arsip Laporan Keuangan</h2>
                        
                        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <!-- Laporan 2025 -->
                            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow flex items-center justify-between group">
                                <div class="flex items-center gap-4">
                                    <div class="w-12 h-12 rounded-xl bg-red-50 flex items-center justify-center shrink-0">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-file-text w-6 h-6 text-[#D62828]"><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"></path><path d="M14 2v4a2 2 0 0 0 2 2h4"></path><path d="M10 9H8"></path><path d="M16 13H8"></path><path d="M16 17H8"></path></svg>
                                    </div>
                                    <div>
                            ...
                            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow flex items-center justify-between group">
                                <div class="flex items-center gap-4">
                                    <div class="w-12 h-12 rounded-xl bg-gray-50 flex items-center justify-center shrink-0">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-file-text w-6 h-6 text-gray-500"><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"></path><path d="M14 2v4a2 2 0 0 0 2 2h4"></path><path d="M10 9H8"></path><path d="M16 13H8"></path><path d="M16 17H8"></path></svg>
                                    </div>
                                    <div>
