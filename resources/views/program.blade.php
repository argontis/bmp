...
<head>
    ...
    <title>Program - Bakti Merah Putih</title>
                ...
                <main class="min-h-screen bg-[#FBFAF7]">
                    ...
                    <div class="bg-[#12355B] text-white pt-[140px] pb-24 relative overflow-hidden">
                        ...
                        <div class="max-w-[1280px] mx-auto px-6 relative z-10 text-center">
                            <h1 class="text-4xl md:text-5xl font-extrabold mb-6" style="font-family: 'Plus Jakarta Sans', sans-serif;">Program Penyaluran Bantuan</h1>
                            <p class="text-white/80 max-w-2xl mx-auto text-lg leading-relaxed">Berbagai pilar program utama Bakti Merah Putih untuk menghadirkan dampak positif di seluruh pelosok Indonesia.</p>
                        </div>
                    </div>

                    <!-- Program Grid -->
                    <div class="max-w-[1280px] mx-auto px-6 -mt-10 relative z-20 pb-24">
                        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            ...
                            <div class="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow border border-gray-100 flex flex-col group">
                                <div class="h-56 overflow-hidden relative">
                                    ...
                                    <img src="/images/program-guru.webp" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="Bakti Guru">
                            ...
                            <div class="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow border border-gray-100 flex flex-col group">
                                <div class="h-56 overflow-hidden relative">
                                    <div class="absolute inset-0 bg-[#0D2137]/20 z-10"></div>
                                    <img src="/images/program-kesehatan.webp" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="Bakti Kesehatan">
                            ...
                            <div class="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow border border-gray-100 flex flex-col group">
                                <div class="h-56 overflow-hidden relative">
                                    <div class="absolute inset-0 bg-[#0D2137]/20 z-10"></div>
                                    <img src="/images/donasi-bencana.webp" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="Bakti Bencana">
                            ...
                            <div class="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow border border-gray-100 flex flex-col group">
                                <div class="h-56 overflow-hidden relative">
                                    <div class="absolute inset-0 bg-[#0D2137]/20 z-10"></div>
                                    <img src="/images/donasi-pangan.webp" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="Bakti Pangan">
                            ...
                            <div class="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow border border-gray-100 flex flex-col group">
                                <div class="h-56 overflow-hidden relative">
                                    <div class="absolute inset-0 bg-[#0D2137]/20 z-10"></div>
                                    <img src="/images/program-lingkungan.webp" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="Bakti Lingkungan">
                            ...
                            <div class="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow border border-gray-100 flex flex-col group">
                                <div class="h-56 overflow-hidden relative">
                                    <div class="absolute inset-0 bg-[#0D2137]/20 z-10"></div>
                                    <img src="/images/program-beasiswa.webp" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="Bakti Pendidikan">
