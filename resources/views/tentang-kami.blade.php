...
<head>
    ...
    <title>Tentang Kami - Bakti Merah Putih</title>
        ...
        <div class="mt-4 pt-4 border-t border-gray-100">
            <a href="/register" class="flex items-center justify-center gap-2 w-full px-5 py-3 bg-[#D62828] text-white rounded-xl text-[15px] font-bold hover:bg-[#B91C1C] transition-all">
                ...
                <main class="min-h-screen bg-[#FBFAF7]">
                    <!-- Page Header -->
                    <div class="bg-[#12355B] text-white pt-[140px] pb-24 relative overflow-hidden">
                        <div class="absolute inset-0 opacity-10" style="background-image: radial-gradient(circle, white 1px, transparent 1px); background-size: 20px 20px;"></div>
                        <div class="max-w-[1280px] mx-auto px-6 relative z-10 text-center">
                            <h1 class="text-4xl md:text-5xl font-extrabold mb-6" style="font-family: 'Plus Jakarta Sans', sans-serif;">Tentang Bakti Merah Putih</h1>
                            <p class="text-white/80 max-w-2xl mx-auto text-lg leading-relaxed">Yayasan sosial yang berdedikasi membangun Indonesia melalui gotong royong, edukasi, kesehatan, dan bantuan kemanusiaan.</p>
                        </div>
                    </div>

                    <!-- Statistics -->
                    <div class="max-w-[1280px] mx-auto px-6 -mt-10 relative z-20 mb-20">
                        <div class="bg-white rounded-2xl shadow-xl p-8 grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-gray-100 border border-gray-50">
                            <div class="pt-4 md:pt-0">
                                <p class="text-4xl font-extrabold text-[#D62828] font-['Plus_Jakarta_Sans'] mb-2">2.4M+</p>
                                <p class="text-gray-500 font-bold uppercase tracking-wider text-xs">Donatur Aktif</p>
                            </div>
                            <div class="pt-4 md:pt-0">
                                <p class="text-4xl font-extrabold text-[#D62828] font-['Plus_Jakarta_Sans'] mb-2">500+</p>
                                <p class="text-gray-500 font-bold uppercase tracking-wider text-xs">Program Berjalan</p>
                            </div>
                            <div class="pt-4 md:pt-0">
                                <p class="text-4xl font-extrabold text-[#D62828] font-['Plus_Jakarta_Sans'] mb-2">34</p>
                                <p class="text-gray-500 font-bold uppercase tracking-wider text-xs">Provinsi Terjangkau</p>
                            </div>
                        </div>
                    </div>

                    <!-- Visi & Misi -->
                    <div class="max-w-[1280px] mx-auto px-6 pb-24">
                        <div class="grid md:grid-cols-2 gap-12">
                            <!-- Visi -->
                            <div class="bg-white p-10 rounded-[24px] shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                                <div class="w-16 h-16 rounded-2xl bg-blue-50 flex items-center justify-center mb-8">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-eye w-8 h-8 text-blue-600"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                                </div>
                                <h2 class="text-3xl font-extrabold text-[#1B1B1B] mb-5" style="font-family: 'Plus Jakarta Sans', sans-serif;">Visi Kami</h2>
                                <p class="text-gray-600 leading-relaxed text-lg">
                                    Menjadi wadah kepedulian masyarakat Indonesia yang terpercaya dalam mewujudkan kesejahteraan sosial dan kemandirian bangsa yang berkelanjutan melalui semangat gotong royong.
                                </p>
                            </div>
                            
                            <!-- Misi -->
                            <div class="bg-white p-10 rounded-[24px] shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                                <div class="w-16 h-16 rounded-2xl bg-emerald-50 flex items-center justify-center mb-8">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-target w-8 h-8 text-emerald-600"><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="6"></circle><circle cx="12" cy="12" r="2"></circle></svg>
                                </div>
                                <h2 class="text-3xl font-extrabold text-[#1B1B1B] mb-5" style="font-family: 'Plus Jakarta Sans', sans-serif;">Misi Kami</h2>
                                <ul class="space-y-5 text-gray-600 leading-relaxed text-lg list-none">
                                    <li class="flex items-start gap-4">
                                        <div class="mt-2 w-2 h-2 rounded-full bg-emerald-500 shrink-0"></div>
                                        Menyalurkan bantuan kemanusiaan secara cepat dan tepat sasaran.
                                    </li>
                                    <li class="flex items-start gap-4">
                                        <div class="mt-2 w-2 h-2 rounded-full bg-emerald-500 shrink-0"></div>
                                        Meningkatkan kualitas pendidikan dan kesehatan masyarakat pelosok.
                                    </li>
                                    <li class="flex items-start gap-4">
                                        <div class="mt-2 w-2 h-2 rounded-full bg-emerald-500 shrink-0"></div>
                                        Membangun transparansi pelaporan donasi berbasis teknologi digital.
                                    </li>
                                </ul>
                            </div>
                        </div>
