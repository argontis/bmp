        ...
        <div class="mt-6 space-y-5">
            <div>
                ...
                <div class="grid grid-cols-3 gap-2">
                    <button class="rounded-xl border py-2.5 text-xs font-bold transition border-[#12355B]/10 bg-white text-[#12355B] hover:border-[#12355B]/30">Rp 25.000</button>
                    <button class="rounded-xl border py-2.5 text-xs font-bold transition border-[#12355B]/10 bg-white text-[#12355B] hover:border-[#12355B]/30">Rp 50.000</button>
                    <button class="rounded-xl border py-2.5 text-xs font-bold transition border-[#D62828] bg-[#FFF1F1] text-[#D62828]">Rp 100.000</button>
                    <button class="rounded-xl border py-2.5 text-xs font-bold transition border-[#12355B]/10 bg-white text-[#12355B] hover:border-[#12355B]/30">Rp 250.000</button>
                    <button class="rounded-xl border py-2.5 text-xs font-bold transition border-[#12355B]/10 bg-white text-[#12355B] hover:border-[#12355B]/30">Rp 500.000</button>
                    <button class="rounded-xl border py-2.5 text-xs font-bold transition border-[#12355B]/10 bg-white text-[#12355B] hover:border-[#12355B]/30">Rp 1.000.000</button>
                </div>
            </div>
            <div>
            ...
            <button onclick="window.location.href='/pembayaran'" class="w-full rounded-xl bg-[#D62828] py-4 text-sm font-bold text-white shadow-md transition hover:bg-[#b91e26] active:scale-95">Lanjutkan Pembayaran Rp 100.000</button>
        </div>
    </div>
</div>
