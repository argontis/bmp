...
<head>
    ...
    <title>Pemberdayaan 100 Ibu Tangguh Melalui Program Modal Usaha Bergulir - Bakti Merah Putih</title>
        ...
        <div class="max-w-[800px] mx-auto px-6 py-12 md:py-16">
            <div class="mb-8">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <span class="text-sm font-semibold text-gray-500">10 Agustus 2026</span>
            ...
            <div class="w-full h-[400px] md:h-[500px] rounded-[24px] overflow-hidden mb-12 shadow-lg">
                <img src="https://images.unsplash.com/photo-1556761175-5973dc0f32e7?w=1200&h=600&fit=crop" class="w-full h-full object-cover">
            </div>
