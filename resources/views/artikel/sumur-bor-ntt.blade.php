...
<head>
    ...
    <title>Peresmian 5 Titik Sumur Bor Baru di NTT Akhiri Krisis Air Bersih - Bakti Merah Putih</title>
        ...
        <div class="max-w-[800px] mx-auto px-6 py-12 md:py-16">
            <div class="mb-8">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <span class="text-sm font-semibold text-gray-500">15 Agustus 2026</span>
            ...
            <div class="w-full h-[400px] md:h-[500px] rounded-[24px] overflow-hidden mb-12 shadow-lg">
                <img src="https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=1200&h=600&fit=crop" class="w-full h-full object-cover">
            </div>
