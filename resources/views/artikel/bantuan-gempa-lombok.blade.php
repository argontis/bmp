        ...
        <div class="max-w-[800px] mx-auto px-6 py-12 md:py-16">
            <div class="mb-8">
                <div class="flex items-center gap-3 mb-6">
                    <span class="px-4 py-1.5 rounded-full text-xs font-bold text-white" style="background: rgb(214, 40, 40);">Sosial & Kemanusiaan</span>
                    <span class="text-sm font-semibold text-gray-500">5 Juli 2026</span>
                    <span class="text-gray-300">•</span>
                    <span class="text-sm font-semibold text-gray-500">4 menit baca</span>
                </div>
                <h1 class="text-4xl md:text-[42px] font-extrabold text-[#12355B] leading-[1.2] mb-6" style="font-family: 'Plus Jakarta Sans', sans-serif;">Bantuan Logistik dan Dapur Umum untuk Korban Gempa di Lombok</h1>
            </div>
            
            <div class="w-full h-[400px] md:h-[500px] rounded-[24px] overflow-hidden mb-12 shadow-lg">
                <img src="https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?w=1200&h=600&fit=crop&auto=format" alt="Bantuan Gempa Lombok" class="w-full h-full object-cover">
            </div>
