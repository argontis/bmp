        ...
        <div class="max-w-[800px] mx-auto px-6 py-12 md:py-16">
            <div class="mb-8">
                <div class="flex items-center gap-3 mb-6">
                    <span class="px-4 py-1.5 rounded-full text-xs font-bold text-white" style="background: rgb(217, 119, 6);">Kesehatan</span>
                    <span class="text-sm font-semibold text-gray-500">25 Juli 2026</span>
                    <span class="text-gray-300">•</span>
                    <span class="text-sm font-semibold text-gray-500">3 menit baca</span>
                </div>
                <h1 class="text-4xl md:text-[42px] font-extrabold text-[#12355B] leading-[1.2] mb-6" style="font-family: 'Plus Jakarta Sans', sans-serif;">Akses Kesehatan Gratis Jangkau 5 Desa di Pedalaman Maluku</h1>
            </div>
            
            <div class="w-full h-[400px] md:h-[500px] rounded-[24px] overflow-hidden mb-12 shadow-lg">
                <img src="https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=1200&h=600&fit=crop&auto=format" alt="Klinik Terapung Maluku" class="w-full h-full object-cover">
            </div>
