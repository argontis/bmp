                ...
                <main class="min-h-screen bg-[#FBFAF7]">
                    ...
                    <div class="bg-[#12355B] text-white pt-[140px] pb-32 relative overflow-hidden">
                        ...
                        <div class="max-w-[1280px] mx-auto px-6 relative z-10 text-center">
                            <h1 class="text-4xl md:text-5xl font-extrabold mb-6" style="font-family: 'Plus Jakarta Sans', sans-serif;">Kabar & Cerita Terkini</h1>
                            <p class="text-white/80 max-w-2xl mx-auto text-lg leading-relaxed">Ikuti perkembangan terbaru, cerita inspiratif, dan laporan penyaluran bantuan dari berbagai pelosok Indonesia.</p>
                        </div>
                    </div>
                        ...
                        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                            ...
                            <div onclick="window.location.href='{{ route('artikel.show', $article->slug) }}'" class="bg-white rounded-[24px] overflow-hidden shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 group cursor-pointer flex flex-col">
                                <div class="h-56 overflow-hidden relative bg-gray-100">
                                    @if($article->image)
                                    <img src="{{ asset($article->image) }}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="{{ $article->title }}">
                                    @else
