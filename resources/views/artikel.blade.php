                ...
                <main class="min-h-screen bg-[#FBFAF7]">
                    ...
                    <div class="max-w-[1280px] mx-auto px-6 -mt-20 relative z-20 pb-24">
                        ...
                        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                            <!-- Article 1 -->
                            <div class="bg-white rounded-[24px] overflow-hidden shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 group cursor-pointer flex flex-col">
