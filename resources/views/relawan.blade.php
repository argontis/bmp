    ...
    <nav class="flex flex-col p-6 gap-4 overflow-y-auto">
        ...
        <div class="mt-4 pt-4 border-t border-gray-100">
            <a href="/register" class="flex items-center justify-center gap-2 w-full px-5 py-3 bg-[#D62828] text-white rounded-xl text-[15px] font-bold hover:bg-[#B91C1C] transition-all">
                        ...
                        <div class="max-w-[1280px] mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
                            <div>
                                ...
                                <div class="flex flex-wrap items-center gap-4">
                                    @auth
                                        <button onclick="window.location.href='/explore'" class="px-8 py-4 rounded-full bg-[#D62828] hover:bg-[#B91C1C] text-white font-bold transition-all shadow-[0_8px_25px_-8px_rgba(214,40,40,0.6)] hover:-translate-y-1">Daftar Sekarang</button>
                                    @else
                                        <button onclick="window.location.href='/register'" class="px-8 py-4 rounded-full bg-[#D62828] hover:bg-[#B91C1C] text-white font-bold transition-all shadow-[0_8px_25px_-8px_rgba(214,40,40,0.6)] hover:-translate-y-1">Register Akun</button>
                                    @endauth
                                    <button onclick="window.open('https://youtu.be/-WIMvjdgp5E?si=1HFWAtSO3fgLP4sx', '_blank')" class="px-8 py-4 rounded-full bg-white/10 hover:bg-white/20 text-white font-bold transition-all backdrop-blur-sm border border-white/20 flex items-center gap-2">
                            ...
                            <div class="grid md:grid-cols-2 gap-8">
                                ...
                                <div class="bg-[#FBFAF7] rounded-3xl p-8 border border-gray-100 flex flex-col md:flex-row gap-6 items-center">
                                    <div class="w-full md:w-40 h-40 rounded-2xl overflow-hidden shrink-0 relative">
                                        <img src="{{ $campaign->image ? asset($campaign->image) : 'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=800&h=600&fit=crop' }}" class="w-full h-full object-cover" alt="{{ $campaign->name }}">
                                    ...
                                    <div class="flex-1 w-full">
                                        ...
                                        <div class="flex flex-col sm:flex-row items-center gap-4 justify-between mt-4">
                                            ...
                                            <div class="flex flex-col sm:flex-row gap-3">
                                                @auth
                                                <button onclick="window.location.href='/explore'" class="w-full sm:w-auto px-5 py-2.5 rounded-full bg-white border-2 border-gray-200 hover:border-[#D62828] hover:text-[#D62828] text-[#1B1B1B] font-bold text-sm transition-colors">Daftar Relawan</button>
                                                @else
                                                <button onclick="window.location.href='/register'" class="w-full sm:w-auto px-5 py-2.5 rounded-full bg-white border-2 border-gray-200 hover:border-[#D62828] hover:text-[#D62828] text-[#1B1B1B] font-bold text-sm transition-colors">Register Akun</button>
                                                @endauth
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-span-1 md:col-span-2 text-center py-12">
                                    ...
                                    @auth
                                        <button onclick="window.location.href='/explore'" class="mt-4 px-5 py-2 rounded-full bg-gray-100 hover:bg-gray-200 text-[#1B1B1B] font-bold text-sm transition-colors">Daftar Relawan Umum</button>
                                    @else
                                        <button onclick="window.location.href='/register'" class="mt-4 px-5 py-2 rounded-full bg-gray-100 hover:bg-gray-200 text-[#1B1B1B] font-bold text-sm transition-colors">Register Akun</button>
                                    @endauth
                                </div>
                                @endforelse
                            </div>
                ...
                <div class="fixed bottom-0 left-0 right-0 p-4 bg-white border-t border-gray-100 shadow-[0_-10px_40px_rgba(0,0,0,0.05)] sm:hidden z-50 transform transition-transform duration-300">
                    <button onclick="window.location.href='{{ auth()->check() ? '/explore' : '/register' }}'" class="flex w-full items-center justify-center gap-2 px-7 py-4 bg-[#D62828] text-white rounded-full font-extrabold text-sm shadow-[0_18px_40px_-10px_rgba(214,40,40,0.8)] active:scale-95 transition-all">
                        @auth
                            Daftar Sekarang
                        @else
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-log-in w-4 h-4"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" x2="3" y1="12" y2="12"/></svg> Register Akun
                        @endauth
                    </button>
                </div>
            </div>
